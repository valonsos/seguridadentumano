...
<div class="fieldcontain ${hasErrors(bean: distritoInstance, field: 'entidad', 'error')} required">
	...
	<g:select id="entidad" name="entidad.id" from="${com.guendabiaani.domain.setm.Estado.list()}" optionKey="id" required="" value="${distritoInstance?.entidad?.id}" class="many-to-one"/>
</div>
