	...
	<body>
		...
		<div id="show-estado" class="content scaffold-show" role="main">
			...
			<ol class="property-list estado">
				...
				<g:if test="${estadoInstance?.coordenadas}">
				<li class="fieldcontain">
					<span id="coordenadas-label" class="property-label"><g:message code="estado.coordenadas.label" default="Coordenadas" /></span>
					
						<g:each in="${estadoInstance.coordenadas}" var="c">
