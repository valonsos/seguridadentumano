			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="clave" title="${message(code: 'region.clave.label', default: 'Clave')}" />
				...
				<g:each in="${regionInstanceList}" status="i" var="regionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${regionInstance.id}">${fieldValue(bean: regionInstance, field: "clave")}</g:link></td>
					
						<td>${fieldValue(bean: regionInstance, field: "descripcion")}</td>
