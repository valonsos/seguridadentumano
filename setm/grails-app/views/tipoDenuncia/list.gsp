	...
	<body>
		...
		<div id="list-tipoDenuncia" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="descripcion" title="${message(code: 'tipoDenuncia.descripcion.label', default: 'Descripcion')}" />
				...
				<g:each in="${tipoDenunciaInstanceList}" status="i" var="tipoDenunciaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${tipoDenunciaInstance.id}">${fieldValue(bean: tipoDenunciaInstance, field: "descripcion")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${tipoDenunciaInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
