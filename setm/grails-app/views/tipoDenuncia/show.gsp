...
<html>
	...
	<body>
		...
		<div id="show-tipoDenuncia" class="content scaffold-show" role="main">
			...
			<ol class="property-list tipoDenuncia">
			
				<g:if test="${tipoDenunciaInstance?.descripcion}">
				<li class="fieldcontain">
					<span id="descripcion-label" class="property-label"><g:message code="tipoDenuncia.descripcion.label" default="Descripcion" /></span>
					
						<span class="property-value" aria-labelledby="descripcion-label"><g:fieldValue bean="${tipoDenunciaInstance}" field="descripcion"/></span>
