		...
		<div id="show-transporte" class="content scaffold-show" role="main">
			...
			<ol class="property-list transporte">
				...
				<li class="fieldcontain">
					<span id="descripcion-label" class="property-label"><g:message code="transporte.descripcion.label" default="Descripcion" /></span>
					
						<span class="property-value" aria-labelledby="descripcion-label"><g:fieldValue bean="${transporteInstance}" field="descripcion"/></span>
